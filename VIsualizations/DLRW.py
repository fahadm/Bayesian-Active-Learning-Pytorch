...
#    train_data_all = train_data_all[0:10000,:,:]
    ...
    return torch.from_numpy(train_data_all.numpy()/255).float(), torch.from_numpy(train_target_all.numpy()) , train_data_val/255,train_target_val, train_data_pool/255, train_target_pool
